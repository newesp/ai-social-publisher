...
export async function POST(request, { params }) { try { return await handlers.sendMessage(request, (await params).id); } catch (error) { return routeErrorResponse(error, NextResponse); } }
